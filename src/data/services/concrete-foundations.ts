...
export const concreteFoundations: ServiceContent = {
  ...
  benefits: [
    ...
    {
      title: "Moisture Barriers Tailored to Pacific Northwest Conditions",
      description:
    ...
    {
      title: "Precise Leveling for Seattle's Variable Soil Conditions",
      description:
    ...
    {
      title: "Code-Compliant Anchor Bolt and Holddown Installation",
      description:
    ...
    {
      title: "Full Coordination with Structural Engineers and Building Inspectors",
      description:
    ...
    {
      title: "Slab-on-Grade, Stem Wall, and Crawl Space Expertise",
      description:
  ...
  processSteps: [
    {
      step: "01",
      title: "Plan Review, Permit Coordination, and Site Investigation",
      description:
    ...
    {
      step: "02",
      title: "Layout, Excavation, and Subgrade Verification",
      description:
    ...
    {
      step: "03",
      title: "Footing Forming, Reinforcement, and Pre-Pour Inspection",
      description:
    ...
    {
      step: "04",
      title: "Concrete Placement, Consolidation, and Anchor Hardware Setting",
      description:
    ...
    {
      step: "05",
      title: "Curing, Moisture Protection, and Final Inspection",
      description:
  ...
  caseStudy: {
    title: "Accessory Dwelling Unit Foundation on Georgetown Infill Lot",
    neighborhood: "Georgetown",
    projectType: "New Construction Slab-on-Grade Foundation with Stem Walls",
    challenge:
  ...
  faqs: [
    {
      question: "How much does a concrete foundation cost in Seattle?",
      answer:
    ...
    {
      question: "Do I always need a geotechnical report for a new foundation in Seattle?",
      answer:
    ...
    {
      question: "What is the difference between a slab foundation and a crawl space foundation in Seattle?",
      answer:
    ...
    {
      question: "How long does a concrete foundation take to pour and cure in Seattle?",
      answer:
    ...
    {
      question: "How do Seattle's seismic risks affect my foundation design?",
      answer:
  ...
  localContext:
    "Seattle's foundation landscape is as geologically diverse as the city's topography. The upland plateau neighborhoods — Ravenna, Wedgwood, Roosevelt, and the northern ridgeline communities — sit on dense glacial till deposited by the last continental ice sheet, providing excellent bearing capacity at shallow depths. But travel downhill to the valleys and former tideflats — Georgetown, South Park, parts of SODO and Interbay — and the picture changes dramatically. These areas are underlain by loose alluvial deposits, historical fill, and in some cases former wetland organic soils that compress under load and amplify seismic ground motion. Understanding which soil regime you are working in is the foundation of every foundation decision, and Cloud Concrete of Seattle has built on every soil type Seattle has to offer.\n\nThe city's aggressive housing density push — specifically its program supporting DADUs and accessory dwelling units on existing residential lots — has generated a wave of new foundation work in established neighborhoods. Many of these infill lots are in Georgetown, Beacon Hill, Rainier Valley, and the Central District, where lot conditions are often complicated by fill, contamination, or proximity to critical areas. We have become a preferred subcontractor for DADU builders and general contractors working through Seattle's DADU permitting process because our knowledge of Seattle DCI's foundation inspection requirements and our ability to coordinate with geotechnical engineers accelerates projects that otherwise stall at the structural review stage.\n\nSeismic preparedness is never far from any Seattle foundation conversation. The region's last major Cascadia Subduction Zone event occurred in January 1700, and geologists are clear that the next one is a matter of when, not if. Seattle building codes reflect this reality, and every foundation we pour is built to the current seismic provisions — anchor bolt spacing, continuous reinforcing, holddown hardware — as a non-negotiable baseline. When homeowners ask us about retrofitting older foundations, we can assess the existing anchor bolt patterns and stem wall connections and recommend the targeted upgrades that bring legacy construction closer to current life-safety standards.",
  ...
  whyChooseUs:
    "Foundation work is the one concrete application where a mistake is genuinely catastrophic and functionally impossible to undo without demolishing the structure above it. Cloud Concrete of Seattle treats every foundation project with that gravity. We work from engineer-stamped plans, we do not pour until the DCI inspector has signed off on reinforcement and forms, and we document every pour with delivery tickets and test cylinder records that become part of the permanent project file. This is not bureaucratic box-checking — it is the professional standard that protects our clients and ensures the structure above performs as designed for the life of the building.\n\nOur team has poured foundations under every category of Seattle structure: single-family homes, multi-family buildings, DADUs, commercial buildings, and industrial slabs on challenging fill sites. That breadth means we are not improvising when we encounter geotechnical complications, tight access constraints, or unusual structural configurations. We have seen the conditions, solved the problem before, and we bring that institutional knowledge to every new job site. We also maintain strong working relationships with the geotechnical engineers and structural engineers who work most frequently in Seattle, enabling us to resolve design questions rapidly when field conditions diverge from plan assumptions.\n\nFor a free foundation consultation and estimate, call Cloud Concrete of Seattle at (206) 495-0997. We are available to review structural plans, advise on pre-construction soil investigation, and coordinate directly with your project's design team. When the most important pour of your project happens, we will be there — on site, on spec, and ready for inspection.",
