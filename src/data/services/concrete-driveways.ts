...
export const concreteDriveways: ServiceContent = {
  ...
  benefits: [
    ...
    {
      title: "Deep Subgrade Preparation and Compaction",
      description:
    ...
    {
      title: "Grade 60 Rebar and Fiber Reinforcement",
      description:
    ...
    {
      title: "Precision Slope and Drainage Engineering",
      description:
    ...
    {
      title: "Long-Term Property Value and Curb Appeal",
      description:
    ...
    {
      title: "Compliant with Seattle Permitting Requirements",
      description:
  ...
  processSteps: [
    {
      step: "01",
      title: "Site Evaluation and Design Consultation",
      description:
    ...
    {
      step: "02",
      title: "Permitting and Utility Locating",
      description:
    ...
    {
      step: "03",
      title: "Demolition, Excavation, and Base Preparation",
      description:
    ...
    {
      step: "04",
      title: "Forming, Reinforcement, and Concrete Placement",
      description:
    ...
    {
      step: "05",
      title: "Curing, Sealing, and Final Walkthrough",
      description:
  ...
  caseStudy: {
    title: "Steep Slope Driveway Replacement on Capitol Hill",
    neighborhood: "Capitol Hill",
    projectType: "Residential Driveway Replacement",
    challenge:
  ...
  faqs: [
    ...
    {
      question: "How long does a concrete driveway last in the Pacific Northwest?",
      answer:
    ...
    {
      question: "Do I need a permit for a new concrete driveway in Seattle?",
      answer:
    ...
    {
      question: "Can I use deicing salt on my concrete driveway in Seattle?",
      answer:
    ...
    {
      question: "How soon can I drive on my new concrete driveway?",
      answer:
