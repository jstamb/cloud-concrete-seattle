...
export const exposedAggregate: ServiceContent = {
  ...
  faqs: [
    ...
    {
      question: "Is exposed aggregate more slippery than regular concrete when wet?",
      answer: "Exposed aggregate is consistently more slip-resistant than smooth-finished concrete when wet—this is one of its primary functional advantages and a key reason why it is so popular for driveways, pool decks, and walkways in Seattle's rainy climate. The protruding stone aggregate breaks up the water film that forms on smooth surfaces and creates mechanical friction between the aggregate and the sole of a shoe or tire tread. The level of traction depends on aggregate size and exposure depth: larger aggregate with greater exposure depth provides more grip, while finer aggregate with shallow exposure is smoother but still significantly more traction-positive than broom-finished concrete in wet conditions.",
    },
    {
      question: "Can exposed aggregate be done on a sloped driveway in Seattle?",
      answer: "Yes, and exposed aggregate is actually an excellent choice for sloped driveways precisely because of its superior wet-weather traction. Seattle's hillier neighborhoods—Capitol Hill, Queen Anne, Beacon Hill, Magnolia, and West Seattle—have driveways with grades ranging from 5 percent to as steep as 15 percent in some cases, and a slip-resistant surface is essential for safe vehicle and pedestrian use. We adjust the concrete mix design for sloped pours to ensure the mix does not flow down the grade before achieving the initial set, and we manage drainage carefully to route runoff away from the public sidewalk and into the property's stormwater system or a discrete strip drain. We have successfully completed exposed aggregate driveways on slopes that other contractors have turned down as too challenging.",
    },
    {
      question: "How is exposed aggregate maintained, and does it need to be resealed in Seattle?",
      answer: "Yes, resealing every 3 to 5 years is the most important maintenance practice for exposed aggregate in Seattle's climate, and it is non-negotiable for preventing freeze-thaw damage. An unsealed or under-sealed surface absorbs water, which freezes in the cement paste around the aggregate stones, causes micro-fractures, and eventually leads to aggregate pop-out—the stone literally pushed out of the surface by ice expansion. Beyond sealing, routine maintenance is minimal: annual cleaning with a pressure washer at moderate pressure to remove moss, algae, and organic debris, and periodic inspection for joint sealant failure. Avoid using strong acids or alkalis for cleaning, as these can etch the cement paste and dull the aggregate. We offer a maintenance sealing program for our installed surfaces—call us at (206) 495-0997 for details.",
    },
  ],

  localContext: "Exposed aggregate concrete has been a Pacific Northwest landscape staple for decades, and for good reason: the surface looks completely at home in a region where natural stone, river gravel, and native plantings define the outdoor aesthetic. From the Craftsman bungalows of Wallingford and Phinney Ridge to the mid-century moderns of Maple Leaf and Wedgwood, exposed aggregate driveways and patios complement virtually every residential architectural style common to Seattle. We regularly work in these neighborhoods and understand how to select aggregate colors and textures that harmonize with each property's exterior palette, hardscape, and planting design rather than competing with them.\n\nSeattle's climate is particularly well-suited to exposed aggregate as a surface choice. The mild but persistently wet winters—with over 150 rainy days per year and annual rainfall averaging 37 inches—demand surfaces that maintain traction when wet, and exposed aggregate's natural texture provides that consistently where smooth or lightly textured finishes fail. The city's steep topography, particularly in neighborhoods like Capitol Hill, Beacon Hill, Queen Anne, and the slopes of West Seattle near Alki Beach, makes slip-resistant driveways and walkways a genuine safety consideration, not just an aesthetic preference. We have installed exposed aggregate on some of the steepest residential driveways in the city and know how to manage both the pour technique and drainage design for optimal results on challenging grades.\n\nFor properties near Seattle's many parks, waterfronts, and natural areas—Gas Works Park in Wallingford, Seward Park on Lake Washington, the Ravenna Park trails, or the Burke-Gilman Trail corridor through the University District—exposed aggregate provides a paving surface that transitions naturally to the surrounding landscape rather than imposing an urban flatwork aesthetic on a naturalistic setting. When homeowners in these neighborhoods seek to connect their private outdoor spaces to the feeling of the adjacent natural environment, exposed aggregate is consistently the finish we recommend. Its honest use of natural stone material, its compatibility with Pacific Northwest plant palettes, and its proven durability in our specific climate make it an enduring choice that continues to gain popularity among Seattle homeowners who prioritize both aesthetics and performance.",
  ...
  whyChooseUs: "Cloud Concrete of Seattle has been installing exposed aggregate concrete across the greater Seattle area for years, developing both the technical expertise and the local material relationships needed to deliver consistently excellent results on this demanding decorative finish. Exposed aggregate is one of the most technique-sensitive of all concrete finishes—the window between surface retarder application and wash-out is measured in hours and varies with temperature, humidity, concrete temperature, and aggregate type. Our crews have developed the experience to read these variables and time the wash-out sequence precisely, resulting in consistent aggregate exposure depth and uniformity across the entire slab. Call us at (206) 495-0997 to schedule a consultation and see aggregate samples in person.\n\nOur relationship with regional aggregate suppliers gives us access to a broad selection of PNW-appropriate materials—river gravels, basalt chips, quartzite, and custom blends—that we can present to clients in physical sample form during the design process. We do not commit to an aggregate specification from a brochure or a website image; we show clients actual material in natural light conditions so the final selection is made with full visual confidence. This attention to the design process is part of why our exposed aggregate projects consistently exceed client expectations and generate referrals.\n\nEvery exposed aggregate installation we complete includes proper joint layout, air-entrained concrete specified for Seattle's freeze-thaw exposure class, and a two-coat sealer application after the 28-day cure as a standard part of the project—not an add-on. We back our work with a written warranty and are fully licensed, bonded, and insured in Washington State. Our W-2 crew members are the same team members on every project—experienced concrete finishers who have honed the retarder and wash-out technique specific to Pacific Northwest aggregate types and climate conditions. The difference between a great exposed aggregate job and a mediocre one is entirely in execution, and execution is where Cloud Concrete of Seattle excels.",
