...
export const concreteSidewalks: ServiceContent = {
  ...
  whyChooseUs: "Cloud Concrete of Seattle is a fully licensed, bonded, and insured concrete contractor with deep experience navigating SDOT, SDCI, and Seattle Urban Forestry permit requirements for sidewalk work throughout the city. We have installed and repaired sidewalks in virtually every Seattle neighborhood—from the flat commercial corridors of SoDo and Georgetown to the steep residential blocks of Capitol Hill, Queen Anne, and Beacon Hill—and that breadth of geographic experience means we anticipate the challenges unique to each area before we show up on your site. Call us at (206) 495-0997 for a free site assessment and honest scope recommendation.\n\nUnlike general contractors who do occasional flatwork or landscape crews who dabble in concrete, sidewalk installation is a core competency for our team. We understand ADA technical standards well enough to design compliant solutions on challenging sites where grade changes or tree root conflicts make compliance difficult to achieve. Our permit specialists manage the SDOT and SDCI application processes entirely in-house, and our long-standing relationship with city inspectors means our projects move through the inspection pipeline efficiently.\n\nWe also stand behind the quality of our specifications. Every residential sidewalk we install uses air-entrained concrete—the freeze-thaw-resistant mix that prevents the surface scaling and spalling that plagues lower-quality installations in Seattle's climate. We apply penetrating sealer to every finished walk as a standard inclusion, not an upsell. And our crews clean up thoroughly, restore disturbed landscaping, and conduct a final walkthrough before we consider a project complete. In a market where concrete contractors often treat small sidewalk jobs as low-priority work, we give every project the attention it deserves—because a well-built walkway reflects on our reputation every time someone walks by.",
