...
export const stampedConcrete: ServiceContent = {
  ...
  benefits: [
    ...
    {
      title: "Integral Color Plus Antique Release for Unmatched Depth",
      description:
    ...
    {
      title: "UV-Stable, High-Gloss or Matte Sealing Options",
      description:
    ...
    {
      title: "Monolithic, Weed-Free Surface with No Shifting Joints",
      description:
    ...
    {
      title: "Versatility Across All Outdoor Living Applications",
      description:
    ...
    {
      title: "Long-Term Cost Advantage Over Natural Stone",
      description:
  ...
  processSteps: [
    {
      step: "01",
      title: "Pattern, Color, and Design Selection",
      description:
    ...
    {
      step: "02",
      title: "Excavation, Base Preparation, and Forming",
      description:
    ...
    {
      step: "03",
      title: "Concrete Placement and Color Application",
      description:
    ...
    {
      step: "04",
      title: "Stamping, Detailing, and Joint Tooling",
      description:
    ...
    {
      step: "05",
      title: "Curing Period and Sealer Application",
      description:
  ...
  caseStudy: {
    title: "Ashlar Slate Patio and Walkway in Laurelhurst",
    neighborhood: "Laurelhurst",
    projectType: "Residential Stamped Concrete Patio and Entry Walkway",
    challenge:
  ...
  faqs: [
    {
      question: "How long does stamped concrete last in Seattle's wet climate?",
      answer:
    ...
    {
      question: "Will stamped concrete be slippery when wet in Seattle's rainy weather?",
      answer:
    ...
    {
      question: "How much does stamped concrete cost compared to pavers or natural stone in Seattle?",
      answer:
    ...
    {
      question: "Can stamped concrete be repaired if it cracks?",
      answer:
    ...
    {
      question: "What stamped concrete patterns work best for a Seattle home exterior?",
      answer:
