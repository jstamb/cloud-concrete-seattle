...
export const poolDecks: ServiceContent = {
  ...
  faqs: [
    ...
    {
      question: "Does my pool deck require a permit from the City of Seattle?",
      answer: "In most cases, replacing or installing a concrete pool deck requires a building permit from Seattle's Department of Construction and Inspections (SDCI), particularly if the deck is structurally attached to the pool shell or if any grading work is involved. Projects in Seattle's shoreline zones — including properties near Lake Washington in neighborhoods like Laurelhurst, Windermere, and Seward Park — may also require a Shoreline Substantial Development Permit if the project exceeds a threshold cost. Cloud Concrete handles the permit application process as part of larger pool deck projects and coordinates inspections so work proceeds without compliance gaps. We review permit requirements during the initial site consultation."
    },
    {
      question: "How long will a new concrete pool deck last in Seattle's climate?",
      answer: "A properly designed and installed concrete pool deck in the Seattle area should last 25–40 years before requiring major structural work. The key variables that determine longevity are: concrete mix design (air-entrained concrete resists freeze-thaw damage), drainage slope (ponding water accelerates deterioration), the sealing program (a resealed deck every 2–3 years maintains chemical and moisture resistance), and the quality of expansion joint materials (flexible joint filler prevents water intrusion at the pool coping interface). Seattle's climate is relatively mild — we do not experience the extreme freeze-thaw frequency of colder climates — which is actually an advantage for pool deck longevity compared to, say, the Midwest. The biggest threat to pool decks here is persistent moisture infiltration combined with pool chemical exposure if the sealing program lapses."
    },
    {
      question: "Can you resurface my existing pool deck instead of replacing it?",
      answer: "Yes, if the existing concrete slab is structurally sound — meaning it has not settled significantly, does not have full-depth cracks across multiple panels, and has adequate thickness — resurfacing with a microtopography overlay or a stamped overlay system is an excellent option that costs roughly 40–60% of full replacement. We apply a polymer-modified overlay at 1/4 to 3/8 inch thickness over the prepared existing slab, which can be stamped, stained, and sealed to achieve a completely transformed appearance. The critical prerequisite is a thorough assessment of the existing slab's bond potential — we core the slab and perform a tensile bond test to confirm the overlay will adhere — and any areas with active water infiltration or settlement must be addressed first. Call us at (206) 495-0997 to schedule a condition assessment."
    },
    {
      question: "How much does a concrete pool deck cost in Seattle?",
      answer: "Pool deck pricing in Seattle varies considerably based on size, finish complexity, demolition scope, and drainage requirements. A basic broom-finished replacement deck runs approximately $8–$12 per square foot installed, while stamped concrete pool decks with color and texture work typically range from $14–$22 per square foot. Resurfacing an existing structurally sound deck with a decorative overlay runs $6–$14 per square foot depending on the overlay system and pattern complexity. Cool-deck coatings add approximately $2–$4 per square foot to any base finish. Permit fees, if required, are an additional cost typically ranging from $500–$2,500 depending on project scope. We provide detailed written estimates with no hidden costs after the initial site visit."
    }
  ],

  localContext: "Seattle's pool season is shorter than in Southern California or Arizona, but homeowners across the city take their backyard pools seriously — investing in resort-quality outdoor spaces that extend usable time as much as possible into the cool spring and fall shoulder seasons. Neighborhoods like Laurelhurst, Windermere, Madison Park, and Madrona along Lake Washington have some of the highest concentrations of in-ground pools in the city, and the mature landscaping and craftsman or mid-century architecture in these areas demands pool deck designs that complement the broader property character rather than clash with it. We have completed pool deck projects throughout these lakeside neighborhoods and understand the design sensibility that prevails.\n\nThe Seattle climate presents specific engineering considerations for pool decks that don't apply in drier climates. The combination of pool splash, rainfall, and the mild but persistent freeze-thaw cycles experienced during Seattle winters means that pool deck concrete must be designed for moisture resistance from the outset. We specify air-entrained concrete with a water-to-cement ratio below 0.45 for all pool deck work, and we insist on positive drainage slopes — a minimum 1/8 inch per foot away from the pool bond beam — on every project. Seattle's glacial-till soils also have varying bearing capacity, and we conduct subbase assessments on every pool deck project to determine whether native soil is adequate or whether imported crushed rock is needed to prevent differential settlement.\n\nBeyond the technical requirements, Seattle homeowners who invest in pool deck renovations typically do so as part of broader outdoor living improvements that may include adjacent concrete patios, concrete steps leading from the house, retaining walls managing grade transitions, and landscape curbing defining planting beds. Cloud Concrete's capability across all of these concrete disciplines means we can serve as the single contractor for the entire outdoor concrete scope, ensuring material consistency, color coordination, and seamless transitions between functional areas of the yard. Call us at (206) 495-0997 to discuss your complete outdoor vision."
  ...
  whyChooseUs: "Cloud Concrete of Seattle approaches every pool deck project as a precision engineering exercise combined with a design collaboration. Our crews have completed pool deck installations and resurfacing projects across dozens of Seattle neighborhoods, giving us direct experience with the soil conditions, drainage challenges, and design vocabularies that characterize different parts of the city. We bring stamped pattern samples, color chip systems, and sealer sheen samples to every initial consultation so you can make informed decisions with physical materials in hand rather than guessing from a website photo.\n\nOur technical standards exceed the minimums for pool deck construction. We use air-entrained concrete mixes as standard on all pool decks — not an upgrade — because Seattle's winters, though mild, include enough freeze-thaw cycling to damage non-air-entrained concrete over time. We place expansion joints wherever required by thermal movement calculations, not just where they are convenient. Our drainage grading is confirmed with a four-foot level after pour, not estimated by eye. These details are invisible once the deck is complete, but they are what separates a deck that looks beautiful for 30 years from one that begins cracking and spalling within five.\n\nWe also back our pool deck installations with a written warranty covering structural defects and stand behind our color and finish work. Call Cloud Concrete of Seattle at (206) 495-0997 to schedule your free site consultation and design session. We serve the entire Seattle metropolitan area and can typically accommodate initial consultations within a week."
  ,
