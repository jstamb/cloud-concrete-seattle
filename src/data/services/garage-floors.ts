  ...
  benefits: [
    {
      ...
      description: "Our garage slabs are engineered to support modern full-size SUVs, pickup trucks, and shop equipment weighing several tons without cracking or settling. We specify the correct PSI mix design—typically 4,000 to 4,500 PSI for residential garages and 5,000 PSI or higher for workshops—and reinforce with rebar or fiber mesh as the application demands. You will never deal with cracked corners or slab deflection under a loaded truck or floor jack.",
    },
    {
      title: "Oil, Chemical, and Moisture Resistance",
      description: "Bare concrete is porous and absorbs motor oil, brake fluid, antifreeze, and road grime, creating stains that never fully lift. We integrate moisture barriers beneath the slab and offer epoxy or polyurea topcoat systems that seal the surface at the molecular level, making spills bead up for easy cleanup. Seattle's wet climate means groundwater vapor is a constant threat; our vapor-barrier installations keep your garage floor dry year-round.",
    },
    {
      title: "Slip-Resistant Surface Options",
    ...
    {
      title: "Freeze-Thaw Cycle Durability",
    ...
    {
      title: "Precision Flatness and Drainage Slope",
      description: "A garage floor that pools water encourages rust on tools and vehicle undercarriages, grows mold, and creates a slipping hazard. We laser-screed and finish every garage slab to precise F-number tolerances, with a deliberate 1/8-inch-per-foot slope toward the apron or floor drain. Water from wet vehicles, hose-downs, and cleaning sessions flows directly out rather than pooling in low spots.",
    },
    {
      title: "Long-Term Cost Savings Over Coated Panels",
      description: "Interlocking rubber or plastic tile systems marketed as garage floor solutions require ongoing replacement, crack under point loads like jack stands, and allow moisture to accumulate beneath them. A properly installed concrete slab with a quality polyurea coating costs more upfront but typically delivers 20 to 30 years of maintenance-free service. When you account for the lifecycle cost, concrete is invariably the more economical choice for Seattle homeowners who plan to stay in their homes.",
    },
  ],
