...
export const concreteRetainingWalls: ServiceContent = {
  ...
  benefits: [
    ...
    {
      title: "Drainage Systems That Eliminate Hydrostatic Pressure",
      description:
    ...
    {
      title: "Creates Usable Flat Space on Sloped Seattle Lots",
      description:
    ...
    {
      title: "Cantilevered and Gravity Wall Options for Every Scale",
      description:
    ...
    {
      title: "Aesthetically Integrated with Decorative Finish Options",
      description:
    ...
    {
      title: "Fully Compliant with Seattle's Critical Areas Regulations",
      description:
  ...
  processSteps: [
    {
      step: "01",
      title: "Site Assessment, Engineering Consultation, and Design",
      description:
    ...
    {
      step: "02",
      title: "Permitting and Geotechnical Coordination",
      description:
    ...
    {
      step: "03",
      title: "Excavation, Footing Location, and Drainage Rough-In",
      description:
    ...
    {
      step: "04",
      title: "Stem Wall Forming, Reinforcement, and Concrete Placement",
      description:
    ...
    {
      step: "05",
      title: "Form Stripping, Backfill, and Site Restoration",
      description:
  ...
  caseStudy: {
    title: "Cantilevered Retaining Wall and Patio Terrace in West Seattle",
    neighborhood: "West Seattle",
    projectType: "Residential Cantilevered Retaining Wall with Terrace",
    challenge:
  ...
  faqs: [
    {
      question: "How tall can a concrete retaining wall be before I need a permit in Seattle?",
      answer:
    ...
    {
      question: "How much does a concrete retaining wall cost in Seattle?",
      answer:
    ...
    {
      question: "Why do retaining walls fail, and how do I know if mine is in danger?",
      answer:
    ...
    {
      question: "What is the difference between a gravity wall and a cantilevered wall?",
      answer:
    ...
    {
      question: "Can a concrete retaining wall be built near my property line in Seattle?",
      answer:
