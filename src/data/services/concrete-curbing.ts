...
export const concreteCurbing: ServiceContent = {
  ...
  whyChooseUs: "Cloud Concrete of Seattle has installed thousands of linear feet of landscape curbing across Seattle's residential neighborhoods, and our crews approach every project with an attention to line quality and detail that separates professional concrete curbing from the stepped, wavy results that characterize inexperienced installation. A concrete curb is only as good as the layout line it follows: we spend time at every project ensuring the marking is true to the homeowner's vision before a single inch of extrusion is committed. Our extrusion machine operators maintain consistent speed and technique to produce a uniform profile cross-section across the full run, and our finishing crew hand-details every transition, corner, and step-down to the same standard as the machine-extruded sections.\n\nWe use a quality concrete mortar formulated specifically for curbing applications — not a general-purpose mix that saves material cost at the expense of durability. Our integral colorants are UV-stable mineral oxides that do not fade or chalk in Seattle's sunlight and rain exposure, and we apply a quality penetrating sealer on every project as standard rather than as an optional upgrade. The sealer is what protects the color and the concrete surface from Seattle's moss, rain, and the chlorine occasionally present in irrigation water, and it is included in our standard pricing because we consider it inseparable from a quality installation.\n\nFor homeowners considering concrete curbing as part of a broader landscape hardscape renovation, Cloud Concrete offers coordinated planning across all concrete elements: curbing, concrete patios, concrete steps, and concrete walkways, ensuring color and material consistency throughout the project. Call us at (206) 495-0997 to schedule a free layout consultation and estimate. We serve all Seattle neighborhoods and can typically complete residential curbing projects within one to two days, weather permitting."
  ,
