...
export const concretePatios: ServiceContent = {
  ...
  benefits: [
    ...
    {
      title: "Finish Options from Classic to Contemporary",
      description:
    ...
    {
      title: "Structural Integrity Through Seattle's Wet Winters",
      description:
    ...
    {
      title: "Seamless Integration with Outdoor Living Design",
      description:
    ...
    {
      title: "Low Maintenance in a High-Moisture Environment",
      description:
    ...
    {
      title: "Permeable Options for Seattle Stormwater Compliance",
      description:
  ...
  processSteps: [
    {
      step: "01",
      title: "Outdoor Living Consultation and Layout Design",
      description:
    ...
    {
      step: "02",
      title: "Utility Location and Permit Coordination",
      description:
    ...
    {
      step: "03",
      title: "Demolition, Excavation, and Base Compaction",
      description:
    ...
    {
      step: "05",
      title: "Curing, Sealing, and Project Closeout",
      description:
  ...
  caseStudy: {
    title: "Multi-Level Stamped and Broom-Finish Patio in Phinney Ridge",
    neighborhood: "Phinney Ridge",
    projectType: "Residential Multi-Level Outdoor Patio",
    challenge:
  ...
  faqs: [
    {
      question: "How much does a concrete patio cost in Seattle?",
      answer:
    ...
    {
      question: "Do I need a permit to build a concrete patio in Seattle?",
      answer:
    ...
    {
      question: "How do I keep moss and algae off my concrete patio in Seattle?",
      answer:
    ...
    {
      question: "How long does it take to build a concrete patio in Seattle?",
      answer:
    ...
    {
      question: "Can a concrete patio be added later to an existing landscape without disturbing plantings?",
      answer:
