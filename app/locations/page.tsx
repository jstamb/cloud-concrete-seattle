...
export default function LocationsHub() {
  ...
  return (
    <div className="pb-32">
      <BreadcrumbSchema items={[{ name: 'Locations', url: '/locations' }]} />
      ...
      <div className="container mx-auto px-4 py-24">
        ...
        <div className="bg-slate-900 rounded-[3rem] p-16 text-white text-center relative overflow-hidden">
          ...
          <Link href="/contact" className="bg-brand-primary text-white px-10 py-5 rounded-xl font-black text-sm uppercase tracking-widest inline-block shadow-2xl hover:scale-105 transition-all relative z-10">
